...
urlpatterns = (
    ...
    # PB1 Authors Doc
    url(r'authors/PBAuthoringGuide+', RedirectView.as_view(
            url='http://blog.podiobooks.com/wp-content/uploads/2012/09/PBAuthoringGuidev2.0.4.pdf', permanent=True)),

    # PB1 Login Page
    url(r'account|login\.php|Xlogin\.php|register\.php',
    ...
    # PB1 Authors Page
    url(r'authors\.php|authors/pbpro\.php', RedirectView.as_view(
...
if settings.DEBUG:
    ...
    urlpatterns += (
        url(r'^media/(?P<path>.*)$', dev_static_views, {'document_root': settings.MEDIA_ROOT}),
