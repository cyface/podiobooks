...
from podiobooks.core.views.browse import get_comments
...
urlpatterns = (
    ...
    url(r'^title/morevi$',
        RedirectView.as_view(url='/title/morevi-the-chronicles-of-rafe-and-askana-remastered/', permanent=True)),
    ...
    url(r'^title/(?P<slug>[^/]+)/comments/$', get_comments, name='title_detail_comments'),
